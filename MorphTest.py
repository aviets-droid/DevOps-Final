...
class MorphTest(unittest.TestCase):
    ...
    def test_attributes(self):
        self.assertEqual(self.morph.name, "TestMorph")
        self.assertTrue(self.morph.isVisible)
        self.assertEqual(self.morph.level, "Test Recessive")
        self.assertEqual(self.morph.associatedHealthIssue, "Test No Issue")
        self.assertEqual(self.morph.issueDesc, "Test No Issue Desc")
